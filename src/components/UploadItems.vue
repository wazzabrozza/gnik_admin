    ...
    >
      ...
      <v-expansion-panel-content v-for="itemDetail in item.children" :key="itemDetail">
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            <v-card-title class="headline">Are you sure you want to remove this item from the catalogue?</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
        ...
        <v-dialog v-model="dialogArchive" max-width="500px">
          <v-card>
            <v-card-title class="headline">Are you sure you want to archive this item?</v-card-title>
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="blue darken-1" text @click="closeArchive">Cancel</v-btn>
              <v-btn color="blue darken-1" text @click="closeArchive">OK</v-btn>
              <v-spacer></v-spacer>
            </v-card-actions>
          </v-card>
        </v-dialog>
